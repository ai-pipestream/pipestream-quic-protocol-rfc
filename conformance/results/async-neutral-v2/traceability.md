...
| V2-SESSION 1–3 | create/attach/anti-reuse; lost-ACK creation replay; changed-policy CONFLICT; sequence overflow CONFLICT; retirement EXPIRED | g2-crash-after-create-commit, g2-crash-before-create-commit, g3-partial-retirement, g3-nonreusable-history | G2 rows implementing; G3 SPEC |
| V2-OP 1–4 | immutable ops; replay; changed-digest CONFLICT; NOT_FOUND uncertainty; no reapplication after retirement | g2-duplicate-op-changed-params DONE, g2-simultaneous-duplicate DONE, g2-kill-client-after-request-sent, g3-nonreusable-history | 2 DONE, 2 SPEC/impl |
| V2-SET 1–4 | declare/seal rules; increasing IDs; empty-batch rules; pages/more/seal; producer-1 restrictions; child scope allocation | g1-declaration-capacity, g1-out-of-order-pages, g1-mode1-branch, g1-mode2-descendants | SPEC |
| V2-ADMIT 1–4 | header/stream identity; incremental bytes/hash/FIN; install-before-commit; replay without re-execution; funded reservations | g1-oversize-payload, g6-stream-identity-and-fin, g2-drop-reply-admission, g3-input-before-metadata | G2 impl; rest SPEC |
| V2-ATTEMPT 1–4 | retry fences; stale attempt; publication rechecks; lease; restart≠new attempt | g4-stale-attempt-retry, g4-stale-lease-publication, g2-kill-after-admission-before-publication, g2-kill-server-after-admission-recovery DONE | 1 DONE, 3 SPEC/impl |
...
| V2-RESULT 1–7 | manifest commitments; local-vs-remote copies; read pins; expiry refusal; integrity; cross-authority references | g1-zero-output, g7-read-pin-past-expiry, g7-receipt-before-output-expiry, g5-cross-authority-reference, g8-complete-with-pending | SPEC |
...
| V2-STORE 1–7 | crash both sides of commits; restart reconciliation; ownership; cleanup replay; retirement order; measured limits; separate metric scopes | g2-* crash rows, g3-* (6 rows), r-* (7 rows) | crash rows impl; rest SPEC |
...
2. g7-unsafe-clock-refusal needs a subject fixture clock or untrusted-clock
