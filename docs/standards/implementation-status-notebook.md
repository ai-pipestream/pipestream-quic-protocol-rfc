# Implementation status notebook (dated notes, moved out of Appendix D on 2026-09-16)

These are the dated working notes that Appendix D carried until draft-05. They record how the implementations reached their state and are kept for the record; Appendix D now gives the concise status an RFC 7942 section asks for.
...
## Interoperability evidence as recorded on 2026-09-06
